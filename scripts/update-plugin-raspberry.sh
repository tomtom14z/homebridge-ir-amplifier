...
# Script de mise à jour du plugin homebridge-ir-amplifier sur Raspberry Pi
# Usage: curl -sL https://raw.githubusercontent.com/tomtom14z/homebridge-ir-amplifier/main/scripts/update-plugin-raspberry.sh | bash

set -e

echo "🔄 Mise à jour du plugin homebridge-ir-amplifier..."
echo ""
