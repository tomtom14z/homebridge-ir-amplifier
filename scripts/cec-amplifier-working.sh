...
# Script CEC Amplifier fonctionnel - version simplifiée
# Évite les conflits et les erreurs CEC
...
log_message "Starting CEC Amplifier Working service..."
...
# Se déclarer comme Audio System en une seule commande
log_message "Announcing as Audio System (device #5)"
{
    echo "tx 50:47:41:4d:50:4c:49"  # Nom "AMPLi"
    echo "tx 5f:84:40:00:05"        # Audio System à 4000
    echo "tx 5f:87:00:00:00"        # Vendor ID générique
    echo "on 0"                     # Se mettre en mode ON
} | timeout 10 cec-client -s -d 1
...
# Écouter les commandes CEC avec un timeout plus long
log_message "Listening for CEC commands (with 10-minute timeout)..."
...
log_message "CEC Amplifier Working service stopped (timeout or error)"
